...
| **movie_reviews.csv** | CSV file containing a list of movie reviews | Name, Director, Year, Movie Poster, Watched Date, Rating, Review | While logged into Letterboxd go to Settings, then Data, then click on Export Your Data. |
